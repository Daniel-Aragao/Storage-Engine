...
public class Bloco implements IBloco {
	...
	public Bloco(byte containerId, int BlockId, ETipoBlocoArquivo tipoBloco, Descritor descritor)
	 ...
	 * (non-Javadoc)
	 * 
	 * @see gerenciador.arquivos.blocos.IBloco#setEvents(gerenciador.arquivos.
	 * interfaces.IBlocoEvents)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * gerenciador.arquivos.blocos.IBloco#addTupla(gerenciador.arquivos.blocos.
	 * Tupla)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see gerenciador.arquivos.blocos.IBloco#removeTupla(gerenciador.arquivos.
	 * blocos.Tupla)
	 */
	@Override
	...
	public void fromByteArray(byte[] dados) throws IncorrectFormatException {
		this.header = new HeaderBloco(ByteArrayTools.subArray(dados, 0, HEADER_BLOCO_SIZE));

		this.dados = new DadosBloco(ByteArrayTools.subArray(dados, HEADER_BLOCO_SIZE, dados.length - HEADER_BLOCO_SIZE),
				this.getBlocoTupleId(), descritor);
	}
